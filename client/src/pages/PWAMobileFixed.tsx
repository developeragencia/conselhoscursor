...
import { Star, MessageCircle, Calendar, User, Home, Search, Heart, Settings, Phone, Clock, Shield, Sparkles, Crown, Eye } from 'lucide-react';
import { useQuery } from '@tanstack/react-query';
import { LoadingScreen } from '@/components/LoadingScreen';

export default function PWAMobileFixed() {
  ...
  useEffect(() => {
    // Simular carregamento inicial igual ao desktop
  ...
  const renderHomeContent = () => (
    <div className="space-y-6">
      ...
      <div className="px-4">
        ...
        <div className="space-y-3">
          {testimonials && Array.isArray(testimonials) ? testimonials.slice(0, 2).map((testimonial: any) => (
    ...
    <div className="px-4 pt-4">
      ...
      <div className="space-y-3">
        {[
          ...
          { icon: Shield, label: 'Privacidade', count: null }
        ].map((item, index) => (
