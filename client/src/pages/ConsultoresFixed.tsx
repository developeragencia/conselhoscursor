...
const mockConsultants: Consultant[] = [
  {
    ...
    profileImage: "",
    status: 'online',
    description: "Especialista em Tarot Rider-Waite com mais de 15 anos de experiência. Ajudo pessoas a encontrar clareza em questões amorosas e profissionais.",
    experience: "15 anos",
    communicationMethods: ['chat', 'video', 'phone']
  },
  {
    id: 2,
    name: "João Santos",
    ...
    profileImage: "",
    status: 'online',
    description: "Astrólogo com formação em Astrologia Tradicional e Moderna. Elaboro mapas natais e previsões astrológicas personalizadas.",
    experience: "12 anos",
  ...
  },
  {
    ...
    profileImage: "",
    status: 'busy',
    description: "Médium vidente natural, uso minha intuição para orientar pessoas em momentos de dúvida e decisões importantes.",
    experience: "20 anos",
    communicationMethods: ['chat', 'phone']
  }
];

export default function ConsultoresFixed() {
  ...
  // Use dados reais se disponíveis, senão use dados de exemplo
  const consultantList = (consultants as Consultant[]).length > 0 ? (consultants as Consultant[]) : mockConsultants;
